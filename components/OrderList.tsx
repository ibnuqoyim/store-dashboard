...
export default function OrderList({ initialOrders, batches, stores = [] }: { initialOrders: Order[], batches: any[], stores?: Store[] }) {
    ...
    const filteredOrders = useMemo(() => {
        ...
        if (dateFilter.start) {
            result = result.filter(o => new Date(o.date) >= new Date(dateFilter.start))
        }
        if (dateFilter.end) {
            result = result.filter(o => new Date(o.date) <= new Date(dateFilter.end))
        }
        ...
        if (searchTerm) {
            ...
            result = result.filter(o =>
                ...
                (o.phone && o.phone.toLowerCase().includes(lowerSearch))
            )
        }
    ...
    }, [initialOrders, selectedBatchId, statusFilter, dateFilter, searchTerm, sortOrder])
    ...
    useEffect(() => {
        setCurrentPage(1)
    }, [selectedBatchId, statusFilter, dateFilter, searchTerm, sortOrder])
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <Link
                    href="/orders/new"
                    className="bg-blue-600 text-white px-4 py-2 rounded-md flex items-center gap-2 hover:bg-blue-700 transition w-full sm:w-auto justify-center"
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                type="text"
                                placeholder="Customer, invoice, or phone..."
                        ...
                        {paginatedOrders.length === 0 && (
                            <tr>
                                <td colSpan={7} className="px-6 py-4 text-center text-gray-500">
                                    {filteredOrders.length === 0 ? 'No orders found.' : 'No orders found for current page.'}
                                </td>
                            </tr>
                        )}
                    </tbody>
